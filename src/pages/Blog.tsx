...
const FALLBACK_FAQ_ITEMS = [
  { q: 'Кога трябва да се регистрирам по ДДС?', a: 'Задължителна регистрация по ЗДДС е необходима при достигане на облагаем оборот от €51 130 (100 000 лв.) за последните 12 последователни месеца. Доброволна регистрация може да се направи по всяко време.' },
  { q: 'Какви документи са нужни за счетоводно обслужване?', a: 'Основните документи включват: фактури (покупки и продажби), банкови извлечения, касови бележки, договори, ведомости за заплати и осигурителни декларации.' },
  { q: 'Какъв е срокът за подаване на годишна данъчна декларация?', a: 'За юридически лица (ЗКПО) — до 30 юни. За физически лица (ЗДДФЛ) — до 30 април с 5% отстъпка при електронно подаване.' },
  { q: 'Колко струва счетоводно обслужване?', a: 'Ориентировъчно: от €51/месец за малки фирми до 50 документа, до €153+/месец за по-големи компании с пълно обслужване и ТРЗ.' },
  { q: 'Какви са осигуровките за самоосигуряващи се лица?', a: 'Минималният осигурителен доход за 2026 г. е €477 (933 лв.). Минималната месечна вноска е приблизително €149 (292 лв.).' },
  { q: 'Трябва ли да имам касов апарат?', a: 'Да, ако извършвате продажби на стоки или услуги на физически лица и плащането е в брой или с карта. Има изключения за някои свободни професии.' },
  { q: 'Какви глоби грозят при неподадена данъчна декларация?', a: 'За физически лица — от €256 до €1 534. За юридически лица — от €256 до €2 556. При повторно нарушение глобите се удвояват.' },
  { q: 'Какви са предимствата на електронното счетоводство?', a: 'Бърз достъп до документи, автоматизация, по-малко грешки, спестено време и улеснена комуникация с НАП.' },
];
